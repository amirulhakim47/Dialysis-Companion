...
import com.example.yoi.mainmenu.models.PlaceInfo;
...
GoogleApiClient.OnConnectionFailedListener{
    ...
    private void init(){
        ...
        AutocompleteFilter filter =
                new AutocompleteFilter.Builder().setCountry("MY").build();
        ...
        mPlacePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivityForResult(builder.build(activity_maps.this), PLACE_PICKER_REQUEST);
                } catch (GooglePlayServicesRepairableException e) {
                    Log.e(TAG, "onClick: GooglePlayServicesRepairableExeption: " + e.getMessage());
